...
#ifndef BIGRECORD2_HH_1257200599__H_
#define BIGRECORD2_HH_1257200599__H_
...
public:
    ...
    float get_float() const;
    void set_float(const float& v);
    std::array<uint8_t, 16> get_md5() const;
    void set_md5(const std::array<uint8_t, 16>& v);
...
inline
std::array<uint8_t, 16> _bigrecord2_Union__1__::get_md5() const {
    if (idx_ != 1) {
        throw avro::Exception("Invalid type for union");
    }
    return boost::any_cast<std::array<uint8_t, 16> >(value_);
}

inline
void _bigrecord2_Union__1__::set_md5(const std::array<uint8_t, 16>& v) {
    idx_ = 1;
    value_ = v;
}
...
template<> struct codec_traits<testgen2::ExampleEnum> {
    static void encode(Encoder& e, testgen2::ExampleEnum v) {
        if (v > testgen2::ExampleEnum::zero)
        {
            std::ostringstream error;
            error << "enum value " << static_cast<unsigned>(v) << " is out of bound for testgen2::ExampleEnum and cannot be encoded";
    ...
    static void decode(Decoder& d, testgen2::ExampleEnum& v) {
        ...
        if (index > static_cast<size_t>(testgen2::ExampleEnum::zero))
        {
            std::ostringstream error;
