...
#ifndef BIGRECORD_R_HH_1257200599__H_
#define BIGRECORD_R_HH_1257200599__H_
...
enum class ExampleEnum: unsigned {
    zero,
    one,
    two,
    three,
...
struct _bigrecord_r_Union__4__ {
private:
    size_t idx_;
    boost::any value_;
public:
    size_t idx() const { return idx_; }
    std::array<uint8_t, 1> get_val() const;
    void set_val(const std::array<uint8_t, 1>& v);
    bool is_null() const {
        return (idx_ == 1);
    }
    void set_null() {
    ...
    _bigrecord_r_Union__4__();
};

struct _bigrecord_r_Union__5__ {
private:
    size_t idx_;
    boost::any value_;
public:
...
struct RootRecord {
    ...
    std::vector<int32_t > myarraywithDefaultValue;
    ExampleEnum myenum;
    ...
    std::array<uint8_t, 16> myfixed;
    _bigrecord_r_Union__4__ myfixedwithDefaultValue;
    int32_t anotherint;
    std::vector<uint8_t> bytes;
    _bigrecord_r_Union__5__ byteswithDefaultValue;
    RootRecord() :
        mylong(int64_t()),
        ...
        myarraywithDefaultValue(std::vector<int32_t >()),
        myenum(ExampleEnum()),
        ...
        myfixed(std::array<uint8_t, 16>()),
        myfixedwithDefaultValue(_bigrecord_r_Union__4__()),
        anotherint(int32_t()),
        bytes(std::vector<uint8_t>()),
        byteswithDefaultValue(_bigrecord_r_Union__5__())
        { }
};
...
inline
std::array<uint8_t, 1> _bigrecord_r_Union__4__::get_val() const {
    if (idx_ != 0) {
        throw avro::Exception("Invalid type for union");
    }
    return boost::any_cast<std::array<uint8_t, 1> >(value_);
}

inline
void _bigrecord_r_Union__4__::set_val(const std::array<uint8_t, 1>& v) {
    idx_ = 0;
    value_ = v;
}

inline
std::vector<uint8_t> _bigrecord_r_Union__5__::get_bytes() const {
    if (idx_ != 0) {
        throw avro::Exception("Invalid type for union");
    }
    return boost::any_cast<std::vector<uint8_t> >(value_);
...
inline
void _bigrecord_r_Union__5__::set_bytes(const std::vector<uint8_t>& v) {
    idx_ = 0;
    value_ = v;
}
...
inline _bigrecord_r_Union__4__::_bigrecord_r_Union__4__() : idx_(0), value_(std::array<uint8_t, 1>()) { }
inline _bigrecord_r_Union__5__::_bigrecord_r_Union__5__() : idx_(0), value_(std::vector<uint8_t>()) { }
}
namespace avro {
...
template<> struct codec_traits<testgen_r::ExampleEnum> {
    static void encode(Encoder& e, testgen_r::ExampleEnum v) {
        if (v > testgen_r::ExampleEnum::three)
        {
            std::ostringstream error;
            error << "enum value " << static_cast<unsigned>(v) << " is out of bound for testgen_r::ExampleEnum and cannot be encoded";
    ...
    static void decode(Decoder& d, testgen_r::ExampleEnum& v) {
        ...
        if (index > static_cast<size_t>(testgen_r::ExampleEnum::three))
        {
            std::ostringstream error;
...
template<> struct codec_traits<testgen_r::_bigrecord_r_Union__4__> {
    static void encode(Encoder& e, testgen_r::_bigrecord_r_Union__4__ v) {
        e.encodeUnionIndex(v.idx());
        switch (v.idx()) {
        case 0:
            avro::encode(e, v.get_val());
            break;
        case 1:
            e.encodeNull();
            break;
    ...
    static void decode(Decoder& d, testgen_r::_bigrecord_r_Union__4__& v) {
        size_t n = d.decodeUnionIndex();
        if (n >= 2) { throw avro::Exception("Union index too big"); }
        switch (n) {
        case 0:
            {
                std::array<uint8_t, 1> vv;
                avro::decode(d, vv);
                v.set_val(vv);
            }
            break;
...
template<> struct codec_traits<testgen_r::_bigrecord_r_Union__5__> {
    static void encode(Encoder& e, testgen_r::_bigrecord_r_Union__5__ v) {
        e.encodeUnionIndex(v.idx());
        switch (v.idx()) {
        case 0:
            avro::encode(e, v.get_bytes());
    ...
    static void decode(Decoder& d, testgen_r::_bigrecord_r_Union__5__& v) {
        size_t n = d.decodeUnionIndex();
        if (n >= 2) { throw avro::Exception("Union index too big"); }
        switch (n) {
        case 0:
...
template<> struct codec_traits<testgen_r::RootRecord> {
    static void encode(Encoder& e, const testgen_r::RootRecord& v) {
        ...
        avro::encode(e, v.myarraywithDefaultValue);
        ...
        avro::encode(e, v.myfixedwithDefaultValue);
        avro::encode(e, v.anotherint);
        avro::encode(e, v.bytes);
        avro::encode(e, v.byteswithDefaultValue);
    }
        ...
        if (avro::ResolvingDecoder *rd =
            ...
            for (std::vector<size_t>::const_iterator it = fo.begin();
                ...
                case 7:
                    ...
                    break;
                case 8:
                    avro::decode(d, v.myarraywithDefaultValue);
                    break;
                case 9:
                ...
                case 15:
                    ...
                    break;
                case 16:
                    avro::decode(d, v.myfixedwithDefaultValue);
                    break;
                case 17:
                ...
                case 18:
                    ...
                    break;
                case 19:
                    avro::decode(d, v.byteswithDefaultValue);
                    break;
                default:
                    break;
                }
