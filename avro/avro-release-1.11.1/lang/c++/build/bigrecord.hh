...
#ifndef BIGRECORD_HH_1257200599__H_
#define BIGRECORD_HH_1257200599__H_
...
template<> struct codec_traits<testgen::ExampleEnum> {
    static void encode(Encoder& e, testgen::ExampleEnum v) {
        if (v > testgen::ExampleEnum::three)
        {
            std::ostringstream error;
            error << "enum value " << static_cast<unsigned>(v) << " is out of bound for testgen::ExampleEnum and cannot be encoded";
    ...
    static void decode(Decoder& d, testgen::ExampleEnum& v) {
        ...
        if (index > static_cast<size_t>(testgen::ExampleEnum::three))
        {
            std::ostringstream error;
